...
import java.io.File;
// import frc.robot.commands.AimYouFool;
...
public class RobotContainer
{
   ...
   */
    ...
    // alignment
		// driverPS5.axisGreaterThan(3, .1).onTrue(new AimYouFool(true, drivebase).withTimeout(3));
		// driverPS5.axisGreaterThan(4, .1).onTrue(new AimYouFool(false, drivebase).withTimeout(3));
    ...
    .whileTrue(Shooter.setVelocity(RPM.of(4000))); // RPM OF THE FLYWHEEL MOTOR MAX 8000 MIN -8000
...
// Hang
  ...
  public Command getAutonomousCommand()
  {
    ...
    return drivebase.getAutonomousCommand("RightOtto");// Change Name to "LeftOtto" or "RightOtto" 
  }
