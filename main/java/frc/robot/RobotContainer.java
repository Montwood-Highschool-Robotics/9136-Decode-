...
import frc.robot.subsystems.ShooterSubsystemcopy;
...
public class RobotContainer
{
  ...
  private final ShooterSubsystemcopy Shooter2 = new ShooterSubsystemcopy();
  ...
  public RobotContainer()
  {
    ...
    NamedCommands.registerCommand("Rollers", OTB.setVelocity(RPM.of(6000)));
    NamedCommands.registerCommand("StopOTB", OTB.StopOTB());
    NamedCommands.registerCommand("StopRollers", OTB.setVelocity(RPM.of(0)));
    // NamedCommands.registerCommand("OTBUp", OTB.OTBUPBUTSLOW());

    NamedCommands.registerCommand("Shoot", Shooter.setVelocity(RPM.of(5000)));
    NamedCommands.registerCommand("Shoot2", Shooter2.setVelocity2(RPM.of(5000)));
    NamedCommands.registerCommand("Carrier", OTB.Carrier());
    NamedCommands.registerCommand("StopShoot", Shooter.setVelocity(RPM.of(0)));
    NamedCommands.registerCommand("StopShoot2", Shooter2.setVelocity2(RPM.of(0)));
    NamedCommands.registerCommand("StopCarrier", OTB.StopCarrier());
    NamedCommands.registerCommand("Uh", OTB.UH());
  }
   ...
   */
      ...
      driverPS5.R1().onTrue((Commands.runOnce(drivebase::ZeroGyrowAlliance)));
      ...
      driverPS5.R2().whileTrue((Commands.runOnce(drivebase::zeroGyro)).repeatedly());
...
// Shooter
    ...
    Shooter2.setDefaultCommand(Shooter2.setVelocity2(RPM.of(0)));


       //sloshopot//
    operatorPs5.axisGreaterThan(3, .1) // L2
    .whileTrue(Shooter.setVelocity(RPM.of(4500))).whileTrue(Shooter2.setVelocity2(RPM.of(4500))) // RPM OF THE FLYWHEEL1 MOTOR MAX 8000 MIN -8000
    .whileFalse(Shooter.setVelocity(RPM.of(000))).whileFalse(Shooter2.setVelocity2(RPM.of(000)));
        //fasshopot//
    operatorPs5.axisGreaterThan(4, .1) // R2
    .whileTrue(Shooter.setVelocity(RPM.of(5000))).whileTrue(Shooter2.setVelocity2(RPM.of(5000))) // RPM OF THE FLYWHEEL1 MOTOR MAX 8000 MIN -8000
    .whileFalse(Shooter.setVelocity(RPM.of(000))).whileFalse(Shooter2.setVelocity2(RPM.of(000)));
...
// Rollers
    ...
    OTB.setDefaultCommand(OTB.setVelocity(RPM.of(0)));

    operatorPs5.button(2)//cross
    .whileTrue(OTB.setVelocity(RPM.of(-5000))); // RPM OF THE FLYWHEEL1 MOTOR MAX 8000 MIN -8000

    operatorPs5.button(1)//square
    .whileTrue(OTB.setVelocity(RPM.of(5000)));
...
// Hang
  ...
  public Command getAutonomousCommand()
  {
    ...
    return drivebase.getAutonomousCommand("SlightlyLessMIDOTTO");
  }
  // If the shoot from tower path misses its all rods fault
