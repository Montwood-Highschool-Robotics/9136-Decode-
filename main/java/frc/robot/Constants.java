...
public final class Constants
{
  ...
  public static class OTB
  {
    ...
    public static double TRANSFERPEEDIN = .8;
    public static double TRANSFERSPEEDOUT = -.8;
    ...
    public static double ROLLERSWHEELSPEEDOUT = -.8;
    public static double ROLLERSWHEELSPEEDIN = .8;
