...
public final class Constants
{
  ...
  public static final double ROBOT_MASS = (101 - 20.3) * 0.453592; // 32lbs * kg per pound
...
//  }
...

  {
    ...
    public static double FLYWHEELSPEEDOUT = 1;
  ...
  public static class OTB
  {
    ...
    public static double TRANSFERPEEDIN = 1;
    public static double TRANSFERSPEEDOUT = -1;

    public static int m_OTBID = 12; // otb whell 14
    public static int OTBCurrentLimit = 30;
    public static boolean m_OTBInvert = false;
    public static double OTBWHEELSPEEDOUT = 1;
    public static double OTBWHEELSPEEDIN = -1;

    public static int m_RollersID = 14; // otb whell 14
    ...
    public static class Hang
  {
    ...
    public static int HangCurrentLimit = 30;
