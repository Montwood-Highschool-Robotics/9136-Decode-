...
public class SwerveSubsystem extends SubsystemBase
{
  ...
  {
    SmartDashboard.putBoolean("SeesTag", LimelightHelpers.getTV("limelight"));
...
// AUTO AIM THAT CAME WITH THE CODE?!?!?
...
// Since AutoBuilder is configured, we can use it to build pathfinding commands
  ...
  public void setupLimelight()
  {
    ...
    LimelightHelpers.SetFiducialIDFiltersOverride("limelight", new int[]{1, 2, 3, 4}); // Only track these tag IDs
    LimelightHelpers.SetFiducialDownscalingOverride("limelight", 2.0f); // Process at half resolution
